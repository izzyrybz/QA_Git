...
class Orchestrator:
    def __init__(self, question_classifier, double_relation_classifer, parser, filepath, auto_train=True):
...
if __name__ == "__main__":
    ...
    double_relation_classifier_path = "/double_relation_classifier"
    ...
    for qapair in ds.qapairs:
        print('Currently working on the question',qapair.question.text)
        stats.inc("total")
